...
export default class RefreshFlat extends Component {
    constructor(props) {
        ...
        this.duration = 300;
        this.contentView = this.props.contentView || new Error('contentView can not be undefined')
        this.state = {
            status: pull_init,
    ...
    onShouldSetPanResponder(e, gesture) {
        if (!this.isVerticalGesture(gesture.dx, gesture.dy) || this.state.status === pull_refresh_ing || this.state.scrollEnabled) {
            return false;
        }
